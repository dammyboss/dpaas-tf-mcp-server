# EITS Cloud Enablement Azure Application Gateway Module

EITS Terraform module which creates [Azure Application Gateway] resources. This module will:

- Deploy Azure Application Gateway with configurable options
...
- Conditional resource creation using `create_application_gateway` parameter
...
module "application_gateway" {
  source = "git::https://code.experian.local/scm/DPAAS/expn-tf-azure-application-gateway.git"
