# EITS Cloud Enablement Azure Mssql Server Module

EITS Terraform module which creates [Azure Mssql Server] resources. This module will:

- Deploy Azure Mssql Server with configurable options
...
- Conditional resource creation using `create_mssql_server` parameter
- Standardized DPaaS tagging applied automatically

## EITS Security & Compliance

**Last Module Review**: 2026-02-04
...
| --------- | ---- | ------- | ----------- |
| [![tflint](https://img.shields.io/badge/tflint-passed-green)]() | 2026-02-04 | 0.58.1 | Enforces best practices, syntax, naming conventions |
| [![trivy](https://img.shields.io/badge/trivy-passed-green)]() | 2026-02-04 | 0.61.0 | Detects misconfiguration in IaC files, such as Docker, Terraform, etc |
| [![checkov](https://img.shields.io/badge/checkov-passed-green)]() | 2026-02-04 | 3.2.464 | Deeper tfplan scanning for security and compliance issues |
| [![wiz](https://img.shields.io/badge/wiz.io_iac-passed-green)]() | 2026-02-04 | 0.84.0 | Scans tests directory plans for vulnerabilities and risks |
<!-- END_BENCHMARK_TABLE -->
...
```hcl
module "mssql_server" {
  source = "git::https://code.experian.local/scm/DPAAS/expn-tf-azure-mssql-server.git"
