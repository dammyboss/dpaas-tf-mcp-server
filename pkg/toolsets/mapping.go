...
var ToolToToolset = map[string]string{
	...
	// DPaaS Innersource tools
	"dpaas_list_azure_resources":        DPaaS,
	"dpaas_extract_resource_schema":     DPaaS,
	"dpaas_generate_innersource_module": DPaaS,
	"dpaas_validate_module":             DPaaS,
}
