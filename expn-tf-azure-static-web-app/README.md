# EITS Cloud Enablement Azure Static Web App Module

EITS Terraform module which creates [Azure Static Web App] resources. This module will:

- Deploy Azure Static Web App with configurable options
...
- Conditional resource creation using `create_static_web_app` parameter
...
module "static_web_app" {
  source = "git::https://code.experian.local/scm/DPAAS/expn-tf-azure-static-web-app.git"

  create_static_web_app = true
  enabled            = true
