# EITS Cloud Enablement Azure Mssql Database Module

EITS Terraform module which creates [Azure Mssql Database] resources. This module will:

- Deploy Azure Mssql Database with configurable options
...
- Conditional resource creation using `create_mssql_database` parameter
...
module "mssql_database" {
  source = "git::https://code.experian.local/scm/DPAAS/expn-tf-azure-mssql-database.git"
