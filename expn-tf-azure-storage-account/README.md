# EITS Cloud Enablement Azure Storage Account Module

EITS Terraform module which creates [Azure Storage Account] resources. This module will:

- Deploy Azure Storage Account with configurable options
...
- Conditional resource creation using `create_storage_account` parameter
...
module "storage_account" {
  source = "git::https://code.experian.local/scm/DPAAS/expn-tf-azure-storage-account.git"
